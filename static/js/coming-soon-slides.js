...
function renderComingSoonSlides() {
  ...
  if (DataManager.isLoaded) {
    items = DataManager.getPageFilteredItems('coming-soon');
  } else {
    window.addEventListener('dataLoaded', renderComingSoonSlides);
    return;
  }
  ...
  if (window.setupSwiper) window.setupSwiper('#coming-soon .new-content');
}
